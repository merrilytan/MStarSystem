            ...
            <div className={classes.pageContainer}>
                <div className={classes.header}>
                    ...
                    <div className={classes.headerHomeTitle}>
                        <Typography color="primary" className={classes.headerHomeName}>{this.props.home.home_name}</Typography>
                        <Typography className={classes.headerPeopleName}>{`${this.props.home.primary_first_name} ${this.props.home.primary_last_name}`}{this.props.home.secondary_first_name ? ` & ${this.props.home.secondary_first_name}`  : ''}{this.props.home.secondary_last_name ? ` ${this.props.home.secondary_last_name}`  : ''}</Typography>
                    </div>
                </div>
                ...
                <div className={classes.contentArea}>
                    {this.renderSection(this.state.value)}
                </div>
            </div>
        );
    };
